...
| Tool failure | Surface diagnostics or recovery guidance after a tool call fails. | postToolUseFailure | PostToolUse | PostToolUse |
...
```typescript
import { evaluatePolicy, normalizeCopilotEvent } from './policy-core'
