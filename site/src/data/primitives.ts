    ...
    implementations: [
      {
        ...
        location: 'AGENTS.md, .github/copilot-instructions.md, .github/instructions/**/*.instructions.md',
        support: 'full',
        sourceUrl: 'https://docs.github.com/en/copilot/how-tos/copilot-on-github/customize-copilot/add-custom-instructions/add-repository-instructions',
      },
      {
        ...
        location: '~/.claude/CLAUDE.md, ./CLAUDE.md, ./.claude/CLAUDE.md, ./CLAUDE.local.md, .claude/rules/*.md',
        support: 'full',
        sourceUrl: 'https://code.claude.com/docs/en/memory',
      },
      {
      ...
      },
      {
        ...
        location: '~/.codex/AGENTS.md, ~/.codex/AGENTS.override.md, AGENTS.md, AGENTS.override.md, subdir/AGENTS.md, subdir/AGENTS.override.md',
        support: 'full',
        sourceUrl: 'https://developers.openai.com/codex/agent-configuration/agents-md',
      },
    ],
